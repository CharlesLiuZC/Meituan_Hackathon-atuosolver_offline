...
_TRAINED_CONFIG_OVERRIDES = {'auto_strategy_budget_ms': 300.0,
 'local_search_budget_ms': 2800.0,
 'max_generated_strategies': 16,
 'max_candidates_per_mask': 20,
 'special_max_candidates_per_mask': 2,
 'pair_top_k': 28,
 'triple_top_k': 20,
 'try_triples': True,
 'strategies': [(0.0463, 1.0012, 0.0814, 0.1094, 0.0136, 0.3105, 0),
                (0.099, 0.9555, 0.0258, 0.1814, 0.0, 0.0747, 0),
                (0.051, 1.0402, 0.0407, 0.3392, 0.1406, 0.0082, 1),
                (0.0696, 0.9884, 0.1263, 0.0657, 0.0209, 0.1471, 1)]}
CONFIG.update(_TRAINED_CONFIG_OVERRIDES)
_TRAINED_RUNTIME_OVERRIDES = {'low_willingness': {'auto_strategy_budget_ms': 180.0,
 ...
 'scarce_couriers': {'auto_strategy_budget_ms': 300.0,
                     'local_search_budget_ms': 2800.0,
                     'multi_primary_time_budget_ms': 0.0,
                     'backup_time_budget_ms': 850.0,
                     'backup_reallocation_budget_ms': 500.0,
                     'max_extra_couriers_per_bundle': 5,
                     '_runtime_multi_cost_mode': 'sequential'},
 'normal': {'multi_primary_time_budget_ms': 3200.0,
